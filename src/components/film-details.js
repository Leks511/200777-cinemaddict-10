...
const createRatingSectionMarkup = (poster, filmName) => {
  return (
...
const checkWatched = (poster, filmName, isWatched) => {
  return isWatched ? createRatingSectionMarkup(poster, filmName) : ``;
};
...
const createFilmDetailsTemplate = (details) => {
  ...
  const {poster, filmName, originalFilmName, rating, director, writers, actors, releaseDate, duration, country, genres, fullDescription, ageRating, isWatched} = details;

  const ratingSectionMarkup = checkWatched(poster, filmName, isWatched);
